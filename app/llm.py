...
def get_nia_client() -> OpenAI:
    ...
    return OpenAI(api_key=NIA_API_KEY, base_url=NIA_BASE_URL, timeout=NIA_TIMEOUT_SECONDS)
...
def generate_sql(question: str, schema: list[dict[str, Any]]) -> str:
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail="SQL generation service failed") from exc
